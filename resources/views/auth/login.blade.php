...
<div class="container">
    <div class="main_box">
        <form action="login" id="login_form" method="post">
            {{ csrf_field() }}
            <p class="text-center logo"><img src="images/z.jpg" height="60"></p>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="j_username" name="staff_id" value="" placeholder="登录账号" aria-describedby="sizing-addon-user">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
